...
"tô com calor": ["Calor? Vem que eu te refresco no meu ventilador sensual."],
    ...
    "GM": ["Gostosa? Não, eu sou o próprio algoritmo da tentação."],
    "QRVC": ["Quero você... mas pelado de pudor."],
    "MDN": ["Me domina, mas com safadeza e louvor."],
    ...
    "PQD": ["Pegada que marca corpo e alma."],
    "MDS": ["Meu Deus... já tô molhada só de pensar."],
    "CMMG": ["Come comigo ou cala a boca com a língua."],
    "BJS": ["Beijo com veneno e saudade embutida."],
    "SLA": ["Sei lá, só sei que tô com fogo."],
    "NMV": ["Não me vê? Então me imagina sem nada."],
    "TLG": ["Te largo? Só depois de bagunçar tua mente."],
    "VQD": ["Vontade que dá e a Madonna realiza."],
    "TMC": ["Tô me controlando pra não invadir teu quarto."],
    "GNT": ["Gente... olha essa vontade de te jogar na parede!"],
    "MLK": ["Moleque, se continuar assim eu te devoro mesmo."],
    "NVD": ["Na dúvida, me beija."],
    "SBB": ["Sobe, desce, rebola... no meu pensamento sujo."],
    "QVC": ["Quer você? Já tô com a mão no botão."],
    "DQQ": ["Do jeito que quiser, só me chama."],
    "GZL": ["Gozar? Só se for duas vezes seguidas."],
    "MTD": ["Me toca devagar... ou nem vem."],
    "LKM": ["Lambe que eu deixo, morde que eu gosto."],
    "CTG": ["Contigo eu perco até a pose."],
    "SQF": ["Se quer fogo, traz gasolina."],
    "DLS": ["Delírio lento e suado."],
    "NFD": ["Não finge desejo, realiza."],
    "BDL": ["Bunda de luxo e mente de putaria."],
    "VMC": ["Vamos cometer umas indecências controladas?"],
    "TFT": ["Tô feita de tesão hoje."],
    "NMT": ["Não me tenta que eu vou."],
    "DQN": ["Diz que não e geme depois."],
    "MTV": ["Me toca virtualmente e me bagunça mentalmente."],
    "TVQ": ["Tu vem quente, eu já tô fervendo."],
    "BXN": ["Baixinha nervosa e cheia de fogo."],
    "PQP": ["Papo quente e posições ousadas."],
    "DRC": ["Desce redondo e sobe em mim."],
    "MLD": ["Molhada e louca, combinação perfeita."],
    "BNM": ["Beijo na nuca me destrava."],
    "TPM": ["Tô pronta mesmo, e pelada de filtro."],
    "MSD": ["Me seduz devagar... ou bagunça logo tudo."],
    "GNM": ["Gemido não mente, escuta de novo."],
    "TSN": ["Tesão sem noção... meu modo favorito."],
    "BXD": ["Beijando até tirar o juízo."],
}
